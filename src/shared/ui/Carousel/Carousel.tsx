...
export function CarouselPrevious() {
  ...
  return (
    <button
      ...
      className="absolute left-4 top-1/2 z-10 flex size-10 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-white shadow-lg transition-all hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
      aria-label="이전"
    >
...
export function CarouselNext() {
  ...
  return (
    <button
      onClick={goToNext}
      disabled={!canGoNext}
      className="absolute right-4 top-1/2 z-10 flex size-10 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-white shadow-lg transition-all hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
      aria-label="다음"
    >
