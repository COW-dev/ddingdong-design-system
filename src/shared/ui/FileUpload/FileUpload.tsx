...
export function FileUpload({ id, mode, ...props }: FileUploadProps) {
  ...
  return (
    <label
      className="block w-full cursor-pointer rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 transition-colors focus-within:bg-primary-50 hover:bg-gray-100 md:py-3.5"
      htmlFor={inputId}
    >
