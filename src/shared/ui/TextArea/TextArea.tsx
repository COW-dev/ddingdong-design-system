  ...
  return (
    <Flex dir="col" gap={2}>
      <textarea
        rows={rows}
        className={cn(
          'text-gray-900 focus:border-1 w-full resize-none rounded-xl border-none px-4 py-3 outline-1 outline-gray-200 transition-colors placeholder:text-gray-400 focus:border-primary-100',
